...
@XmlRootElement(name = "FinnDokumenterGittSaksnoekkel", namespace = "http://rep.geointegrasjon.no/Arkiv/Innsyn/xml.wsdl/2012.01.31")
public class FinnDokumenterGittSaksnoekkel implements ToString2
{
