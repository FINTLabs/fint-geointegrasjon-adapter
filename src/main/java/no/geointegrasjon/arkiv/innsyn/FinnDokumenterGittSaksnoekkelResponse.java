...
@XmlRootElement(name = "FinnDokumenterGittSaksnoekkelResponse", namespace = "http://rep.geointegrasjon.no/Arkiv/Innsyn/xml.wsdl/2012.01.31")
public class FinnDokumenterGittSaksnoekkelResponse implements ToString2
{
