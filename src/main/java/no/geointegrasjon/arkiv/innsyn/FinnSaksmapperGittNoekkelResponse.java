...
@XmlRootElement(name = "FinnSaksmapperGittNoekkelResponse", namespace = "http://rep.geointegrasjon.no/Arkiv/Innsyn/xml.wsdl/2012.01.31")
public class FinnSaksmapperGittNoekkelResponse implements ToString2
{
