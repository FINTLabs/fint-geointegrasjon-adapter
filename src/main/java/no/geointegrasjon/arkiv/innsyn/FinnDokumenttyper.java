...
@XmlRootElement(name = "FinnDokumenttyper", namespace = "http://rep.geointegrasjon.no/Arkiv/Innsyn/xml.wsdl/2012.01.31")
public class FinnDokumenttyper implements ToString2
{
