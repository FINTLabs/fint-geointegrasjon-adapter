 ...
 *       &lt;sequence&gt;
 *         &lt;element name="matrikkelnr" type="{http://rep.geointegrasjon.no/Matrikkel/Felles/xml.schema/2012.01.31}MatrikkelnummerListe" minOccurs="0"/&gt;
...
@XmlRootElement(name = "SlettMatrikkelnummer")
public class SlettMatrikkelnummer implements ToString2
{

    protected MatrikkelnummerListe matrikkelnr;
    protected Saksnoekkel saksnokkel;
    protected ArkivKontekst kontekst;

    /**
     * Gets the value of the matrikkelnr property.
     * 
     * @return
     *     possible object is
     ...
     *     
     */
    public MatrikkelnummerListe getMatrikkelnr() {
        return matrikkelnr;
    }

    /**
     * Sets the value of the matrikkelnr property.
     * 
     * @param value
     *     allowed object is
     *     {@link MatrikkelnummerListe }
     *     
     */
    public void setMatrikkelnr(MatrikkelnummerListe value) {
        this.matrikkelnr = value;
    }
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy2 strategy) {
        {
            MatrikkelnummerListe theMatrikkelnr;
            theMatrikkelnr = this.getMatrikkelnr();
            strategy.appendField(locator, this, "matrikkelnr", buffer, theMatrikkelnr, (this.matrikkelnr!= null));
        }
        {
