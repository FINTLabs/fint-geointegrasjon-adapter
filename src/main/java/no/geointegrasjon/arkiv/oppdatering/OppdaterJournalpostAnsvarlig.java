...
@XmlRootElement(name = "OppdaterJournalpostAnsvarlig")
public class OppdaterJournalpostAnsvarlig implements ToString2
{
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy2 strategy) {
        {
            String theNyAdministrativEnhetKode;
            theNyAdministrativEnhetKode = this.getNyAdministrativEnhetKode();
            strategy.appendField(locator, this, "nyAdministrativEnhetKode", buffer, theNyAdministrativEnhetKode, (this.nyAdministrativEnhetKode!= null));
        }
        {
            String theNySaksbehandlerInit;
            theNySaksbehandlerInit = this.getNySaksbehandlerInit();
            strategy.appendField(locator, this, "nySaksbehandlerInit", buffer, theNySaksbehandlerInit, (this.nySaksbehandlerInit!= null));
        }
        {
