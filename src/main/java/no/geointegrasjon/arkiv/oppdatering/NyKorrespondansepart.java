 ...
 *       &lt;sequence&gt;
 *         &lt;element name="part" type="{http://rep.geointegrasjon.no/Arkiv/Kjerne/xml.schema/2012.01.31}KorrespondansepartListe" minOccurs="0"/&gt;
...
@XmlRootElement(name = "NyKorrespondansepart")
public class NyKorrespondansepart implements ToString2
{

    protected KorrespondansepartListe part;
     ...
     *     
     */
    public KorrespondansepartListe getPart() {
        return part;
    }
     ...
     *     
     */
    public void setPart(KorrespondansepartListe value) {
        this.part = value;
    }
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy2 strategy) {
        {
            KorrespondansepartListe thePart;
