 ...
 *       &lt;sequence&gt;
 *         &lt;element name="merknad" type="{http://rep.geointegrasjon.no/Arkiv/Kjerne/xml.schema/2012.01.31}MerknadListe" minOccurs="0"/&gt;
...
@XmlRootElement(name = "NyJournalpostMerknad")
public class NyJournalpostMerknad implements ToString2
{

    protected MerknadListe merknad;
     ...
     *     
     */
    public MerknadListe getMerknad() {
        return merknad;
    }
     ...
     *     
     */
    public void setMerknad(MerknadListe value) {
        this.merknad = value;
    }
